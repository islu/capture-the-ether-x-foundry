...
contract TokenBankChallenge {
    ...
    function isComplete() public view returns (bool) {
        return token.balanceOf(address(this)) == 0; // return token.balanceOf(this) == 0;
    }
...
// Enjoy this inspirational music while you work: A British Bank. https://www.youtube.com/watch?v=WDbOK_fDu9Y
